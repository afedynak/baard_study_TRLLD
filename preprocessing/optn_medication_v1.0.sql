...
SELECT 
    ...
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_2_arm_8' AND 
                         ...
                         THEN type_in_rec_med1 END ORDER BY type_in_rec_med1 SEPARATOR ', ') AS week2_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_2_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN adherence_3_freq1 END ORDER BY adherence_3_freq1 SEPARATOR ', ') AS week2_med1_freq,
	GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_2_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN type_in_rec_med2 END ORDER BY type_in_rec_med2 SEPARATOR ', ') AS week2_med2,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_2_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
   ...
   # 
    ...
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_4_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN type_in_rec_med1 END ORDER BY type_in_rec_med1 SEPARATOR ', ') AS week4_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_4_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN adherence_3_freq1 END ORDER BY adherence_3_freq1 SEPARATOR ', ') AS week4_med1_freq,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_4_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN type_in_rec_med2 END ORDER BY type_in_rec_med2 SEPARATOR ', ') AS week4_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_4_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN adherence_3_freq2 END ORDER BY adherence_3_freq2 SEPARATOR ', ') AS week4_med1_freq,
    
    #-- For week 6 event
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_6_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN type_in_rec_med1 END ORDER BY type_in_rec_med1 SEPARATOR ', ') AS week6_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_6_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN adherence_3_freq1 END ORDER BY adherence_3_freq1 SEPARATOR ', ') AS week6_med1_freq,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_6_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN type_in_rec_med2 END ORDER BY type_in_rec_med2 SEPARATOR ', ') AS week6_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_6_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN adherence_3_freq2 END ORDER BY adherence_3_freq2 SEPARATOR ', ') AS week6_med1_freq,
   # 
    #-- For week 8 event
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_8_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN type_in_rec_med1 END ORDER BY type_in_rec_med1 SEPARATOR ', ') AS week8_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_8_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN adherence_3_freq1 END ORDER BY adherence_3_freq1 SEPARATOR ', ') AS week8_med1_freq,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_8_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN type_in_rec_med2 END ORDER BY type_in_rec_med2 SEPARATOR ', ') AS week8_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_8_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN adherence_3_freq2 END ORDER BY adherence_3_freq2 SEPARATOR ', ') AS week8_med1_freq,
   #                  
#-- For week 10 event
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_10end_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN type_in_rec_med1 END ORDER BY type_in_rec_med1 SEPARATOR ', ') AS week10_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_10end_arm_8' AND 
                         (LOWER(type_in_rec_med1) = 'bupropion' OR LOWER(type_in_rec_med1) = 'aripiprazole') 
                         THEN adherence_3_freq1 END ORDER BY adherence_3_freq1 SEPARATOR ', ') AS week10_med1_freq,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_10end_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN type_in_rec_med2 END ORDER BY type_in_rec_med2 SEPARATOR ', ') AS week10_med1,
    GROUP_CONCAT(CASE WHEN BINARY redcap_event_name = 'week_10end_arm_8' AND 
                         (LOWER(type_in_rec_med2) = 'bupropion' OR LOWER(type_in_rec_med2) = 'aripiprazole') 
                         THEN adherence_3_freq2 END ORDER BY adherence_3_freq2 SEPARATOR ', ') AS week10_med1_freq
FROM 
...
FROM baard.optn_decision_support_form_arm_7_8_20250315

WITH adherence_data AS (
    ...
    WHERE (
            adherence_3_med1 LIKE lower('bup%') OR 
            adherence_3_med1 LIKE lower('wel%') OR 
            adherence_3_med1 LIKE lower('bude%')
        )
    ...
    FROM baard.opt_adherence_20250124
    WHERE (
            adherence_3_med2 LIKE lower('bup%') OR 
            adherence_3_med2 LIKE lower('wel%') OR 
            adherence_3_med2 LIKE lower('bude%')
        )
        AND redcap_event_name IN (
            'Step 1 Week 2 (Arm 2: Step 1 Acute)',
            'Step 1 Week 4 (Arm 2: Step 1 Acute)',
